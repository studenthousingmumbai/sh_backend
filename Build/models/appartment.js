...
const appartmentSchema = new mongoose_1.Schema({
    ...
    listing_id: { type: mongoose_1.default.Schema.Types.ObjectId, ref: 'Listing', required: true },
...
const Appartment = (0, mongoose_1.model)("Appartment", appartmentSchema);
exports.default = Appartment;
